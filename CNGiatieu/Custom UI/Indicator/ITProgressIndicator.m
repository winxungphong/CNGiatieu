...
//// ----------------------------------------------------------------------------------------
//
//@interface UIBezierPath (IT_Geometry)
//
//- (UIBezierPath*)it_rotatedBezierPath:(float) angle;
//- (UIBezierPath*)it_rotatedBezierPath:(float) angle aboutPoint:(CGPoint)point;
//
//@end
//
//@implementation UIBezierPath (IT_Geometry)
//
//- (UIBezierPath *)it_rotatedBezierPath:(float)angle {
//	return [self it_rotatedBezierPath:angle aboutPoint:CGPointMake(CGMidX(self.bounds), CGMidY(self.bounds))];
//}
//
//- (UIBezierPath*)it_rotatedBezierPath:(float)angle aboutPoint:(CGPoint)point {
...
//		CGAffineTransform *xfm = [self it_rotationTransformWithAngle:angle aboutPoint:point];
...
//}
//
//- (CGAffineTransform *)it_rotationTransformWithAngle:(const float)angle aboutPoint:(const CGPoint)aboutPoint {
//	CGAffineTransform *xfm = [CGAffineTransform transform];
...
//    UIImage *progressImage = [[UIImage alloc] initWithSize:self.bounds.size];
